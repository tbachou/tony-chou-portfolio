...
- **Career arc**: 6 years production engineering experience via long-term embedded consulting engagements through Tensure Consulting (Mailchimp, Product Forge, Topstep, current internal project). Also holds an M.S. in Occupational Therapy from Ohio State and worked as a licensed OT for 6 years before transitioning into engineering in 2020; he no longer practices, holds no current OT license, and his C/NDT certification is expired — real background, not the headline pitch.
