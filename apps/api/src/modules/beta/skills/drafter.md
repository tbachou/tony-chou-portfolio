...
- **pain_behavior**:
  - `constant_even_at_rest` — most cautious: longer early stages, gentler doses, and an `overallCaution` that pain at rest which does not improve within a couple of weeks deserves a professional assessment.
