...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Beta is a live portfolio demo with real AI costs, so it carries real cost controls: 50 plans per day globally, 6 per visitor, and 3 attempts per hour. When the daily budget is spent the form stays browsable and tells you so honestly. The caps reset at midnight UTC.',
  },
];
