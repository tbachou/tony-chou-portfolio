...
const GUARDRAILS = [
  ...
  'Cost is capped at every layer: 3 requests per hour per IP (in memory), 6 plans per day per IP (persisted), and 50 plans per day globally. Worst-case daily AI spend is bounded no matter the traffic.',
