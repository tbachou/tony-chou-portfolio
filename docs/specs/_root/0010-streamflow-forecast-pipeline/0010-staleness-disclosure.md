...
| `STALE_FORECAST_LEGEND` | Issued more than {hours} hours ago, or from a river reading that old. Either way it was made without the river's current level, and may be well off. |
